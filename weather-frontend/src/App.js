...
const App = () => {
  ...
  const backend_url = "https://weatherconditiontracking.onrender.com/predict";
    ...
    return (
      <div className="card" key={index}>
        ...
        <div className="card-info">
          ...
          {predictions[index] ? (
            <h4 style={{ color: 'green', backgroundColor: 'yellow', display: 'inline' }}>
              Predicted Condition: {predictions[index]}
            </h4>
          ) : (
  ...
  const getPredictionForToday = (weather) => {
    ...
    fetch(backend_url, {
      ...
      .catch((error) => {
        console.error("Error fetching prediction for today:", error);
      });
  };
    ...
    <div className="App">
      ...
      <div className="main-content">
        <div className="left-section">
          {isLoading ? (
            <div className="loader-container main-loader">
              <div className="loader"></div>
                ...
                <div className="current-weather">
                  ...
                  <div className="current-info">
                    <div className="info-left">
                      ...
                      {todayPrediction ? (
                        <h4 style={{ color: 'green', background: 'yellow', display: 'inline' }}>
                          Predicted Condition: {todayPrediction}
                        </h4>
                      ) : (
          ...
          <div className="weather-input">
            <div className="input-container">
              <input
                ...
                disabled={isLoading}
              />
              <button onClick={getCityCoordinates} disabled={isLoading}>
                {isLoading ? 'Searching...' : 'Search'}
              </button>
            </div>
            <div className="or-separator">or</div>
            <button className="location-btn" onClick={getUserCoordinates} disabled={isLoading}>
